...
//Evento associado ao botao de voltar para o menu principal do carão virtual, APENAS DEMOSNTRATIVO INTERAÇÃO ENTRE ESSAS TELAS NÃO ESTÁ PRONTA
voltar.addEventListener("click", function() 
{
  alert("VOLTA A PAGINA DOS CARTÕES");
});
